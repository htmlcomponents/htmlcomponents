  ...
  constructor() {
    ...
    this.buildToolsSettings = {
      ...
      "postcss-cli": {
        ...
        scripts: {
          "build:css":
            "npm run build:css:style && npm run build:css:components",
          "build:css:vite":
            "npm run build:css:style:vite && npm run build:css:components:vite",
          "build:css:style":
            "postcss ./components/utilities/css-imports/style.css -o ./assets/style.css",
          "build:css:style:vite":
            "postcss ./components/utilities/css-imports/style.css -o ./public/assets/style.css",
          "build:css:components":
            "postcss ./components/utilities/css-imports/components.css -o ./assets/components.css",
          "build:css:components:vite":
            "postcss ./components/utilities/css-imports/components.css -o ./public/assets/components.css",
        },
      },
    };
    this.sourceFolders = ["public", "components", "guide"];
  }
